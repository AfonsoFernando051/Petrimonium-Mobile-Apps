...
void main() {
  ...
  testWidgets(
    'renders fallbackBuilder instead of PetMascotWidget when there is no .riv',
    (tester) async {
      final controller = await _catController(FakeMascotRepository());
  ...
  testWidgets(
    'keeps the fallback for a stopgap rig when allowStopgapRigs is false',
    (tester) async {
  ...
  testWidgets(
    'specieOverride renders without waiting for the controller profile to load',
    (tester) async {
