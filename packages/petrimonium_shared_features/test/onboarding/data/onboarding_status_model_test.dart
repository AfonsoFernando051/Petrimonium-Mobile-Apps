...
void main() {
  group('OnboardingStatusModel.fromJson', () {
    test('parses hasAnswered and profile from a complete json map', () {
      final model = OnboardingStatusModel.fromJson(const {'hasAnswered': true, 'profile': 'moderate'});
    ...
    test('parses a null profile when hasAnswered is false', () {
      final model = OnboardingStatusModel.fromJson(const {'hasAnswered': false, 'profile': null});
