...
Academy is a separate installable product. Its native application identifier is
`com.petrimonium.academy` on Android, iOS, macOS and Linux. Do not reuse this ID
for Wallet or Health.
