...
import 'package:petrimonium_academy/features/auth/data/models/user_model.dart';

void main() {
  group('UserModel', () {
    test('fromJson should return a valid model when both email and token are provided', () {
      final Map<String, dynamic> jsonMap = {'email': 'test@test.com', 'accessToken': 'mock_token'};
    ...
    test('fromJson should handle missing token safely', () {
      final Map<String, dynamic> jsonMap = {'email': 'test@test.com'};
    ...
    test('fromJson should handle null email safely fallback to empty string', () {
      final Map<String, dynamic> jsonMap = {'accessToken': 'mock_token'};
    ...
    test('fromJson parses username when present (register/users-me responses)', () {
      final Map<String, dynamic> jsonMap = {'email': 'test@test.com', 'username': 'investor'};
    ...
    test('fromJson handles missing username safely (login response)', () {
      final Map<String, dynamic> jsonMap = {'accessToken': 'mock_token', 'refreshToken': 'mock_refresh_token'};
