...
void main() {
  ...
  test('syncs the completion to the backend when a remote datasource is available', () async {
    when(() => mockRemoteDataSource.completeLesson(any(), perfectFirstTry: any(named: 'perfectFirstTry'))).thenAnswer(
    ...
    verify(() => mockRemoteDataSource.completeLesson('test_lesson', perfectFirstTry: true)).called(1);
  ...
  test('a wrong answer keeps the learner on the question until they pick correctly', () async {
