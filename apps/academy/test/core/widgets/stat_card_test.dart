...
void main() {
  ...
  group('StatCard', () {
    testWidgets('renders the label and value', (tester) async {
      await tester.pumpWidget(wrap(const StatCard(label: 'Valor final', value: 'R\$ 15.2K', accent: Colors.cyan)));
    ...
    testWidgets('applies the accent color to the value text', (tester) async {
      await tester.pumpWidget(wrap(const StatCard(label: 'Total investido', value: 'R\$ 1.0K', accent: Colors.amber)));
