...
class Translator {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'pt': {
      ...
      AppStrings.portfolioChoiceFootnote: 'Sem pressa — {petName} vai estar aqui em cada etapa.',
      ...
      AppStrings.portfolioGuidancePortfolioTitle: 'Sua carteira entra quando fizer sentido',
      ...
      AppStrings.portfolioActivationConnectTitle: 'Vamos adicionar seu primeiro investimento.',
      AppStrings.portfolioActivationConnectBody: 'Registre seus ativos para começar a acompanhar sua carteira.',
      AppStrings.portfolioActivationAddFirstAssetButton: 'Adicionar meu primeiro ativo',
      AppStrings.portfolioActivationLearnTitle: 'Tudo bem. Você pode começar aprendendo.',
      ...
      AppStrings.portfolioActivationExploreJourneyButton: 'Explorar minha jornada',
      ...
      AppStrings.shareProgressXpToNextLabel: '{current}/{total} XP para o próximo nível',
      AppStrings.shareProgressLevelUpBadge: 'Subiu de nível!',
      AppStrings.shareProgressTagline: 'Evoluindo rumo à liberdade financeira 🚀',
      ...
      AppStrings.shareProgressErrorMessage: 'Não foi possível compartilhar agora. Tente novamente.',
      ...
      AppStrings.academyIncorrectFeedbackTitle2: 'Quase. Essa parte costuma confundir mesmo.',
      AppStrings.academyIncorrectFeedbackTitle3: 'Não foi dessa vez. Vamos ver com calma:',
      ...
      AppStrings.labCompoundInterestSubtitle: 'Veja como aporte, prazo e taxa mudam o resultado.',
      ...
      AppStrings.labCompoundInterestOptionB: 'Eles crescem proporcionalmente mais rápido',
      ...
      AppStrings.labInflationSubtitle: 'Veja como a inflação corrói o poder de compra do seu dinheiro.',
      ...
      AppStrings.labFixedIncomeSubtitle: 'Veja como taxa, prazo e aportes fazem sua renda fixa crescer.',
      ...
      AppStrings.labDiversificationSubtitle: 'Monte uma carteira e veja como a concentração afeta o risco.',
      AppStrings.labDiversificationScoreLabel: 'Índice de diversificação',
      AppStrings.labDiversificationEffectiveAssetsLabel: 'Equivale a quantos ativos',
      ...
      AppStrings.labDiversificationConcentrationShockButton: 'Maior posição cai 30%',
      ...
      AppStrings.labDiversificationOptionA: 'Risco de concentração em um único ativo',
      ...
      AppStrings.labPortfolioSubtitle: 'Monte uma carteira hipotética e teste cenários de mercado.',
      ...
      AppStrings.labPortfolioScenarioLargestPositionDown20: 'Maior posição cai 20%',
      ...
      AppStrings.labPortfolioOptionA: 'Porque a carteira combina ativos com pesos diferentes',
      AppStrings.labPortfolioOptionB: 'Porque todos os ativos sempre se movem juntos',
      ...
      AppStrings.homeAnswerInvestorProfileLink: 'Ainda não respondeu seu perfil de risco? Responder agora',
      AppStrings.homeMissionAlmostDoneEyebrow: 'Quase lá',
      AppStrings.homeMissionAlmostDoneBody: 'Falta 1 aula para completar essa missão e ganhar +{xp} XP.',
      ...
      AppStrings.companionInvestorStatusYes: 'Ótimo! Vamos começar registrando seu primeiro investimento.',
      ...
      AppStrings.companionHomeMotivation1: 'Cada pequeno passo te deixa mais preparado para o futuro. Continue assim!',
      ...
      AppStrings.companionHomeMotivation5: 'Cada dia que você volta aqui é um dia mais perto dos seus objetivos.',
      AppStrings.companionHomeReturnGreeting1: 'Bom te ver de novo! Vamos continuar de onde paramos?',
      AppStrings.companionHomeReturnGreeting2: 'Que bom que voltou! Sua jornada continua esperando por você.',
      AppStrings.companionHomeMissionAlmostDone: "Você está a uma aula de completar '{missionTitle}'!",
      ...
      AppStrings.errorNoConnectionMessage: 'Não foi possível conectar. Verifique sua internet e tente novamente.',
      AppStrings.errorUnexpectedMessage: 'Algo inesperado aconteceu. Tente novamente.',
      ...
      AppStrings.mentorRenameConversationFailed: 'Não foi possível renomear a conversa. Tente novamente.',
      ...
      AppStrings.mentorDeleteConversationFailed: 'Não foi possível apagar a conversa. Tente novamente.',
      ...
      AppStrings.profileSettingsHint: 'Gerencie idioma e conta nas configurações.',
    ...
    'pt_PT': {
      ...
      AppStrings.resetPasswordSubtitle: 'Cole o código que enviámos por e-mail e escolha uma nova palavra-passe.',
    ...
    'en': {
      ...
      AppStrings.portfolioChoiceFootnote: "There's no rush — {petName} will be here at every step.",
      ...
      AppStrings.portfolioGuidancePortfolioTitle: 'Your portfolio can wait until it makes sense',
      AppStrings.portfolioGuidancePortfolioBody:
      ...
      AppStrings.portfolioActivationConnectTitle: "Let's add your first investment.",
      AppStrings.portfolioActivationConnectBody: 'Register your assets to start tracking your portfolio.',
      AppStrings.portfolioActivationAddFirstAssetButton: 'Add my first asset',
      AppStrings.portfolioActivationLearnTitle: "That's okay. You can start by learning.",
      AppStrings.portfolioActivationLearnBody:
          "You don't need to have investments yet to start becoming a better investor.",
      AppStrings.portfolioActivationStartAcademyButton: 'Start with the Academy',
      ...
      AppStrings.shareProgressXpToNextLabel: '{current}/{total} XP to next level',
      AppStrings.shareProgressLevelUpBadge: 'Leveled up!',
      AppStrings.shareProgressTagline: 'Leveling up toward financial freedom 🚀',
      AppStrings.shareProgressCta: 'Download Invest Game and start your journey',
      AppStrings.shareProgressButton: 'Share',
      AppStrings.shareProgressContinueButton: 'Continue',
      AppStrings.shareProgressErrorMessage: "Couldn't share right now. Please try again.",
      ...
      AppStrings.academyIncorrectFeedbackTitle2: 'Almost. This part trips people up.',
      AppStrings.academyIncorrectFeedbackTitle3: "Not this time. Let's take a closer look:",
      ...
      AppStrings.labCompoundInterestSubtitle: 'See how contributions, time and rate change the outcome.',
      ...
      AppStrings.labInflationSubtitle: "See how inflation erodes your money's purchasing power.",
      ...
      AppStrings.labFixedIncomeSubtitle: 'See how rate, term and contributions grow your fixed income.',
      ...
      AppStrings.labDiversificationSubtitle: 'Build a portfolio and see how concentration affects risk.',
      AppStrings.labDiversificationScoreLabel: 'Diversification score',
      AppStrings.labDiversificationEffectiveAssetsLabel: 'Equivalent to how many assets',
      ...
      AppStrings.labDiversificationConcentrationShockButton: 'Largest position falls 30%',
      ...
      AppStrings.labDiversificationQuestion: 'Diversification protects against…',
      AppStrings.labDiversificationOptionA: 'Concentration risk in a single asset',
      ...
      AppStrings.labPortfolioSubtitle: 'Build a hypothetical portfolio and test market scenarios.',
      ...
      AppStrings.labPortfolioScenarioLargestPositionDown20: 'Largest position falls 20%',
      ...
      AppStrings.labPortfolioOptionA: 'Because the portfolio combines assets with different weights',
      AppStrings.labPortfolioOptionB: 'Because every asset always moves together',
      ...
      AppStrings.homeAnswerInvestorProfileLink: "Haven't answered your risk profile yet? Answer now",
      AppStrings.homeMissionAlmostDoneEyebrow: 'Almost there',
      AppStrings.homeMissionAlmostDoneBody: '1 more lesson finishes this mission and earns +{xp} XP.',
      ...
      AppStrings.companionInvestorStatusYes: "Great! Let's start by registering your first investment.",
      AppStrings.companionInvestorStatusNo: "No problem! You don't need investments to start your journey.",
      AppStrings.companionActionUnderstand: 'Understand',
      AppStrings.companionHomeMotivation1: 'Every small step gets you more prepared for the future. Keep it up!',
      AppStrings.companionHomeMotivation2:
      ...
      AppStrings.companionHomeMotivation5: 'Every day you come back here is a day closer to your goals.',
      AppStrings.companionHomeReturnGreeting1: 'Good to see you again! Ready to pick up where you left off?',
      AppStrings.companionHomeReturnGreeting2: "Glad you're back! Your journey is still waiting for you.",
      AppStrings.companionHomeMissionAlmostDone: "You're one lesson away from finishing '{missionTitle}'!",
      AppStrings.companionEventMissionCompleted:
      ...
      AppStrings.errorNoConnectionMessage: "Couldn't connect. Check your internet connection and try again.",
      AppStrings.errorUnexpectedMessage: 'Something unexpected happened. Please try again.',
      ...
      AppStrings.mentorRenameConversationFailed: "We couldn't rename the conversation. Please try again.",
      ...
      AppStrings.mentorDeleteConversationFailed: "We couldn't delete the conversation. Please try again.",
      ...
      AppStrings.profileSettingsHint: 'Manage language and account in Settings.',
    ...
    'es': {
      ...
      AppStrings.portfolioChoiceFootnote: 'Sin prisa — {petName} estará aquí en cada etapa.',
      ...
      AppStrings.portfolioGuidancePortfolioTitle: 'Tu cartera entra cuando tenga sentido',
      AppStrings.portfolioGuidancePortfolioBody:
      ...
      AppStrings.portfolioActivationConnectTitle: 'Vamos a agregar tu primera inversión.',
      AppStrings.portfolioActivationConnectBody: 'Registra tus activos para empezar a seguir tu cartera.',
      AppStrings.portfolioActivationAddFirstAssetButton: 'Agregar mi primer activo',
      AppStrings.portfolioActivationLearnTitle: 'Está bien. Puedes empezar aprendiendo.',
      AppStrings.portfolioActivationLearnBody: 'No necesitas tener inversiones para empezar tu camino como inversor.',
      AppStrings.portfolioActivationStartAcademyButton: 'Empezar por la Academia',
      ...
      AppStrings.shareProgressXpToNextLabel: '{current}/{total} XP para el próximo nivel',
      AppStrings.shareProgressLevelUpBadge: '¡Subió de nivel!',
      AppStrings.shareProgressTagline: 'Evolucionando hacia la libertad financiera 🚀',
      AppStrings.shareProgressCta: 'Descarga Invest Game y comienza tu viaje',
      AppStrings.shareProgressButton: 'Compartir',
      AppStrings.shareProgressContinueButton: 'Continuar',
      AppStrings.shareProgressErrorMessage: 'No se pudo compartir ahora. Inténtalo de nuevo.',
      ...
      AppStrings.academyIncorrectFeedbackTitle2: 'Casi. Esta parte suele confundir.',
      AppStrings.academyIncorrectFeedbackTitle3: 'Esta vez no. Vamos verlo con calma:',
      ...
      AppStrings.labCompoundInterestSubtitle: 'Mira cómo el aporte, el plazo y la tasa cambian el resultado.',
      ...
      AppStrings.labCompoundInterestOptionB: 'Crecen proporcionalmente más rápido',
      ...
      AppStrings.labInflationSubtitle: 'Mira cómo la inflación erosiona el poder de compra de tu dinero.',
      ...
      AppStrings.labFixedIncomeSubtitle: 'Mira cómo la tasa, el plazo y los aportes hacen crecer tu renta fija.',
      ...
      AppStrings.labDiversificationSubtitle: 'Arma una cartera y mira cómo la concentración afecta el riesgo.',
      AppStrings.labDiversificationScoreLabel: 'Índice de diversificación',
      AppStrings.labDiversificationEffectiveAssetsLabel: 'Equivale a cuántos activos',
      ...
      AppStrings.labDiversificationConcentrationShockButton: 'La mayor posición cae 30%',
      ...
      AppStrings.labDiversificationQuestion: 'Diversificar protege contra…',
      AppStrings.labDiversificationOptionA: 'Riesgo de concentración en un solo activo',
      ...
      AppStrings.labPortfolioSubtitle: 'Arma una cartera hipotética y prueba escenarios de mercado.',
      AppStrings.labPortfolioTotalAmountLabel: 'Valor total simulado',
      ...
      AppStrings.labPortfolioScenarioLargestPositionDown20: 'La mayor posición cae 20%',
      ...
      AppStrings.labPortfolioOptionA: 'Porque la cartera combina activos con pesos diferentes',
      AppStrings.labPortfolioOptionB: 'Porque todos los activos siempre se mueven juntos',
      ...
      AppStrings.homeAnswerInvestorProfileLink: '¿Aún no respondiste tu perfil de riesgo? Responder ahora',
      AppStrings.homeMissionAlmostDoneEyebrow: 'Casi listo',
      AppStrings.homeMissionAlmostDoneBody: 'Falta 1 lección para completar esta misión y ganar +{xp} XP.',
      ...
      AppStrings.companionInvestorStatusYes: '¡Genial! Vamos a empezar registrando tu primera inversión.',
      AppStrings.companionInvestorStatusNo: '¡No hay problema! No necesitas inversiones para empezar tu camino.',
      AppStrings.companionActionUnderstand: 'Entender',
      AppStrings.companionHomeMotivation1: 'Cada pequeño paso te deja más preparado para el futuro. ¡Sigue así!',
      AppStrings.companionHomeMotivation2: 'Invertir es una maratón, no una carrera. Tu constancia ya es un logro.',
      AppStrings.companionHomeMotivation3:
      ...
      AppStrings.companionHomeMotivation5: 'Cada día que vuelves aquí es un día más cerca de tus objetivos.',
      AppStrings.companionHomeReturnGreeting1: '¡Qué bueno verte de nuevo! ¿Seguimos donde lo dejamos?',
      AppStrings.companionHomeReturnGreeting2: '¡Me alegra que volvieras! Tu viaje todavía te espera.',
      AppStrings.companionHomeMissionAlmostDone: "¡Estás a una lección de completar '{missionTitle}'!",
      AppStrings.companionEventMissionCompleted: '¡Misión completa: {title}! Un paso más hacia un inversor más seguro.',
      AppStrings.companionEventLabSimulatorCompleted:
      ...
      AppStrings.errorNoConnectionMessage: 'No se pudo conectar. Verifica tu conexión a internet e inténtalo de nuevo.',
      AppStrings.errorUnexpectedMessage: 'Ocurrió algo inesperado. Inténtalo de nuevo.',
      ...
      AppStrings.mentorRenameConversationSave: 'Guardar',
      AppStrings.mentorRenameConversationFailed: 'No se pudo renombrar la conversación. Inténtalo de nuevo.',
      ...
      AppStrings.mentorDeleteConversationFailed: 'No se pudo eliminar la conversación. Inténtalo de nuevo.',
      ...
      AppStrings.profileAchievementsComingSoonBody: 'Tus logros e hitos aparecerán aquí a medida que progreses.',
      AppStrings.profileSettingsHint: 'Gestiona idioma y cuenta en configuración.',
  ...
  static Map<String, Map<String, String>> get debugLocalizedValues => _localizedValues;
}
