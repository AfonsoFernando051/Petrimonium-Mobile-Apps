...
/// Collapses the raw [HistoryPoint] series (here, `WealthHistoryCalculator
/// .compute` over the simulated wallet's reconstructed lots — see
/// `SimulatedLotBuilder`) into one sample per calendar month, which is what
/// the Wealth Evolution bar chart plots.
abstract final class MonthlyWealthSeries {
  ...
  ///   really were worth that during a month the source series simply did
  ///   not emit a sample for.
  ///
