...
import 'package:petrimonium_academy/features/simulated_wallet/presentation/widgets/simulated_asset_row.dart';

/// A collapsible category (Ações/FIIs/ETFs/Cripto/...) inside the simulated
/// wallet's holdings, showing an aggregate header and expanding to its
/// individual [SimulatedAssetRow]s. Ported from Wallet's real
/// `ExpandableCategory`.
class SimulatedExpandableCategory extends StatefulWidget {
  const SimulatedExpandableCategory({
    super.key,
    required this.type,
  ...
  @override
  State<SimulatedExpandableCategory> createState() => _SimulatedExpandableCategoryState();
}

class _SimulatedExpandableCategoryState extends State<SimulatedExpandableCategory> {
            ...
            firstChild: Padding(
              ...
              child: Column(
                children: [
                  ...
                  for (final holding in widget.holdings) SimulatedAssetRow(holding: holding),
                ],
              ),
            ),
