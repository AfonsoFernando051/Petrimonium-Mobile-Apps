...
class Translator {
  ...
  static const Map<String, Map<String, String>> _productCopy = {
    'pt': {
      ...
      AppStrings.homeKpiTotalWealthLabel: 'PATRIMÔNIO TOTAL',
      AppStrings.homeKpiTotalWealthTodaySuffix: 'hoje',
      AppStrings.homeKpiInvestedPrefix: 'Valor investido',
      AppStrings.homeKpiTotalProfitLabel: 'LUCRO TOTAL',
      AppStrings.homeKpiProfitCapitalPrefix: 'Capital',
      AppStrings.homeKpiProfitProventosPrefix: 'Proventos',
      AppStrings.homeKpiProventosLabel: 'PROVENTOS (12M)',
      AppStrings.homeKpiProventosCaption: 'Dividendos, JCP e rendimentos',
      AppStrings.homeKpiReturnLabel: 'RENTABILIDADE',
      AppStrings.homeKpiReturn12mPrefix: '12M',
      AppStrings.homeKpiReturnTotalPrefix: 'Total',
      AppStrings.homeKpiAwaitingData: 'Buscando seus proventos confirmados…',
      AppStrings.homeWealthBarsTitle: 'Evolução do patrimônio',
      AppStrings.homeWealthBarsRangeChip: '12 meses',
      AppStrings.homeWealthBarsLegendInvested: 'Valor aplicado',
      AppStrings.homeWealthBarsLegendGain: 'Ganho de capital',
      AppStrings.homeWealthBarsLegendShortfall: 'Abaixo do aplicado',
      AppStrings.homeWealthBarsEmpty: 'Ainda não há histórico suficiente para montar esse gráfico.',
      AppStrings.homeAllocationTitle: 'Ativos na carteira',
      AppStrings.homeAllocationCenterLabel: 'TOTAL',
      ...
      AppStrings.companionBadgeLabel: 'COMPANION',
      AppStrings.homeEmptyStateTitle: 'Sua jornada começa pela carteira',
      AppStrings.homeEmptyStateBody: 'Adicione seu primeiro investimento para acompanhar como seu patrimônio evolui.',
      AppStrings.carteiraEmptyStateTitle: 'Monte sua carteira',
      AppStrings.carteiraEmptyStateBody:
          'Adicione seus investimentos para acompanhar patrimônio, rentabilidade e proventos em um só lugar.',
      AppStrings.portfolioEmptyStateCta: 'Adicionar primeiro investimento',
      AppStrings.homeEmptyKpiWealthLabel: 'Patrimônio',
      AppStrings.homeEmptyKpiReturnLabel: 'Rentabilidade',
      AppStrings.homeEmptyKpiProventosLabel: 'Proventos',
      AppStrings.homeEmptyKpiInsightsLabel: 'Insights',
    ...
    'en': {
      ...
      AppStrings.homeKpiTotalWealthLabel: 'TOTAL WEALTH',
      AppStrings.homeKpiTotalWealthTodaySuffix: 'today',
      AppStrings.homeKpiInvestedPrefix: 'Invested',
      AppStrings.homeKpiTotalProfitLabel: 'TOTAL PROFIT',
      AppStrings.homeKpiProfitCapitalPrefix: 'Capital',
      AppStrings.homeKpiProfitProventosPrefix: 'Income',
      AppStrings.homeKpiProventosLabel: 'INCOME (12M)',
      AppStrings.homeKpiProventosCaption: 'Dividends, interest on equity and yields',
      AppStrings.homeKpiReturnLabel: 'RETURN',
      AppStrings.homeKpiReturn12mPrefix: '12M',
      AppStrings.homeKpiReturnTotalPrefix: 'Total',
      AppStrings.homeKpiAwaitingData: 'Fetching your confirmed income…',
      AppStrings.homeWealthBarsTitle: 'Wealth evolution',
      AppStrings.homeWealthBarsRangeChip: '12 months',
      AppStrings.homeWealthBarsLegendInvested: 'Invested capital',
      AppStrings.homeWealthBarsLegendGain: 'Capital gain',
      AppStrings.homeWealthBarsLegendShortfall: 'Below invested',
      AppStrings.homeWealthBarsEmpty: "There isn't enough history yet to draw this chart.",
      AppStrings.homeAllocationTitle: 'Assets in your portfolio',
      AppStrings.homeAllocationCenterLabel: 'TOTAL',
      ...
      AppStrings.portfolioNotConnectedPetCaption:
          'Your journey starts with your portfolio. Add your first investment and I\'ll follow along from there.',
      AppStrings.companionBadgeLabel: 'COMPANION',
      AppStrings.homeEmptyStateTitle: 'Your journey starts with your portfolio',
      AppStrings.homeEmptyStateBody: 'Add your first investment to track how your wealth evolves.',
      AppStrings.carteiraEmptyStateTitle: 'Build your portfolio',
      AppStrings.carteiraEmptyStateBody: 'Add your investments to track wealth, returns and income in one place.',
      AppStrings.portfolioEmptyStateCta: 'Add first investment',
      AppStrings.homeEmptyKpiWealthLabel: 'Wealth',
      AppStrings.homeEmptyKpiReturnLabel: 'Return',
      AppStrings.homeEmptyKpiProventosLabel: 'Income',
      AppStrings.homeEmptyKpiInsightsLabel: 'Insights',
    ...
    'es': {
      ...
      AppStrings.homeKpiTotalWealthLabel: 'PATRIMONIO TOTAL',
      AppStrings.homeKpiTotalWealthTodaySuffix: 'hoy',
      AppStrings.homeKpiInvestedPrefix: 'Valor invertido',
      AppStrings.homeKpiTotalProfitLabel: 'GANANCIA TOTAL',
      AppStrings.homeKpiProfitCapitalPrefix: 'Capital',
      AppStrings.homeKpiProfitProventosPrefix: 'Ingresos',
      AppStrings.homeKpiProventosLabel: 'INGRESOS (12M)',
      AppStrings.homeKpiProventosCaption: 'Dividendos, JCP y rendimientos',
      AppStrings.homeKpiReturnLabel: 'RENTABILIDAD',
      AppStrings.homeKpiReturn12mPrefix: '12M',
      AppStrings.homeKpiReturnTotalPrefix: 'Total',
      AppStrings.homeKpiAwaitingData: 'Buscando tus ingresos confirmados…',
      AppStrings.homeWealthBarsTitle: 'Evolución del patrimonio',
      AppStrings.homeWealthBarsRangeChip: '12 meses',
      AppStrings.homeWealthBarsLegendInvested: 'Valor aplicado',
      AppStrings.homeWealthBarsLegendGain: 'Ganancia de capital',
      AppStrings.homeWealthBarsLegendShortfall: 'Por debajo de lo aplicado',
      AppStrings.homeWealthBarsEmpty: 'Todavía no hay suficiente historial para armar este gráfico.',
      AppStrings.homeAllocationTitle: 'Activos en la cartera',
      AppStrings.homeAllocationCenterLabel: 'TOTAL',
      ...
      AppStrings.portfolioNotConnectedPetCaption:
          'Tu viaje empieza por tu cartera. Agrega tu primera inversión y te acompaño desde ahí.',
      AppStrings.companionBadgeLabel: 'COMPANION',
      AppStrings.homeEmptyStateTitle: 'Tu viaje empieza por tu cartera',
      AppStrings.homeEmptyStateBody: 'Agrega tu primera inversión para seguir cómo evoluciona tu patrimonio.',
      AppStrings.carteiraEmptyStateTitle: 'Arma tu cartera',
      AppStrings.carteiraEmptyStateBody:
          'Agrega tus inversiones para seguir patrimonio, rentabilidad e ingresos en un solo lugar.',
      AppStrings.portfolioEmptyStateCta: 'Agregar primera inversión',
      AppStrings.homeEmptyKpiWealthLabel: 'Patrimonio',
      AppStrings.homeEmptyKpiReturnLabel: 'Rentabilidad',
      AppStrings.homeEmptyKpiProventosLabel: 'Ingresos',
      AppStrings.homeEmptyKpiInsightsLabel: 'Insights',
