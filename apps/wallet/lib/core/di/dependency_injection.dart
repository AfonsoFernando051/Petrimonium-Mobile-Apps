...
class DI {
  ...
  // Not `final` so tests can replace it with a mock repository.
  static WalletMarketPreferencesRepository walletMarketPreferencesRepository = WalletMarketPreferencesRepository();
  ...
  static final InvestmentRemoteDataSource _investmentRemoteDataSource = InvestmentRemoteDataSource(
    apiClient: _apiClient,
  );
  // Not `final` so tests can replace it with a mock repository.
  ...
  static final AssetDetailsRemoteDataSource _assetDetailsRemoteDataSource = AssetDetailsRemoteDataSource(
    apiClient: _apiClient,
  );
  // Not `final` so tests can replace it with a mock repository.
